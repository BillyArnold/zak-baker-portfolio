...
const Dolby = () => {
  return (
    <>
      <div className="w-full pb-20 dolby-section-mobile">
        <div className="text-center">
          ...
          >
            <p className="text-white font-medium mb-10">
              Dolby Atmos mixes you can trust...
            </p>
          </motion.div>
          ...
          >
            <div className="w-full md:w-[90%] mx-auto flex flex-col items-center">
              <div className="w-full md:w-4/5 text-center   mb-10">
                <p>
                  Blue Bell Hill Studios is equipped with a 7.1.4 Dolby Atmos
                  setup which is officially certified and calibrated by Dolby.
                </p>
              </div>
